...
Functional programming libraries in Javascript such as Ramda include a generic
compose function which does the heavy lifting of combining functions for you. 
...
The arguments f and g are unary functions 
(i.e. functions which take one argument). 
